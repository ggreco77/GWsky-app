...
class LookAroundUI : UI {
    ...
    void SetButtonCallbacks() {
        ...
        ChangeTelescopeButton.onClick.AddListener(delegate () {
            ...
            ChangeTelescopeButton.transform.Find("Telescope Number").GetComponent<TextMeshProUGUI>().text = "" + (data.CurrentPhotosphere + 1);
        });
    }
    ...
    public override IEnumerator Enable() {
        ...
        ChangeTelescopeButton.transform.Find("Telescope Number").GetComponent<TextMeshProUGUI>().text = "" + (_events_db.GetLoadedEvent().CurrentPhotosphere + 1);
        GetComponent<AudioSource>().clip = _events_db.GetLoadedEvent().WaveSound;
